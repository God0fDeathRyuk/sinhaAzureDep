...
<div class="pagetitle w-100 float-start border-bottom pb-1">
    ...
    <div class="col-md-4 float-end text-end mb-2">
        <a href="<?= base_url($data['requested_url']) ?>" class="btn-bck btn btn-dark me-2 eeeee">Exit</a>
        ...
        <?php } else if($option == 'delete') { ?>
            <button type="button" class="btn-save btn btn-secondary" onclick="submitForm('caseStatusForm', 'delete')">Delete</button>
        <?php } ?>
    </div>
    <?php } ?> 
</div>
...
<section class="section dashboard d-inline-block w-100">
            ...
            <?php $accessPermission=explode(",", $session->Accpermission); 
                foreach ($permdata as $value) { 
                    ...
                    if($menuId[$i]==$_REQUEST['menu_id']){ ?>
                        <button type="submit" class="btn btn-primary cstmBtn mt-0 me-2 <?= (in_array($value['id'], $accessPermission)) ? 'd-block float-start' : 'd-none'  ?>"  onclick="formOption('/case/status/', '<?php echo strtolower($value['permission_name']) ?>', 'caseStatus')"><?php echo $value['permission_name']; ?></button>
                <?php }}} ?>
                ...
                <form action="" method="post" id="caseStatusForm" name="caseStatusForm">
                    <div class="sec1 d-inline-block w-100 border mt-3">
                        <div class="inpt-sec-top d-inline-block w-100 p-3 border-bottom">
                            <div class="inpts col-md-3 float-start px-2 mb-2">
                                ...
                                <input type="text" name="serial_no" class="form-control" readonly style="background: #e9ecef;" value="<?= isset($caseHdrArray['serial_no']) ? $caseHdrArray['serial_no'] : '' ?>" />
                            </div>
                            <div class="inpts col-md-3 float-start px-2 mb-2">
                                <label for="" class="d-block w-100 mb-2">Activity Date <strong class="text-danger">*</strong></label>
                                <input type="text" name="activity_date" class="form-control" value="<?= isset($caseHdrArray['activity_date']) ? $caseHdrArray['activity_date'] : date('d-m-Y') ?>" onChange="chkActivityDate(this)" <?= $redv ?> onBlur="make_date(this)" required/>
                            </div>
                            <div class="inpts col-md-3 float-start px-2 mb-2">
                                <label for="" class="d-block w-100 mb-2">Branch <strong class="text-danger">*</strong></label>
                                <select class="form-select"  name="branch_code" id="branchCode" <?= $disview ?> required>
                                <?php foreach($data['branches'] as $branch) { ?>
                                <option value="<?= $branch['branch_code'] ?>" <?= ($branch['branch_code'] == $data['branch_code']['branch_code']) ? 'selected' : '' ?>><?= $branch['branch_name'] ?></option>
                                <?php } ?>
                                </select>
                            ...
                            <div class="inpts col-md-3 float-start px-2">
                                ...
                                <?php if($option =='letter') { ?>
                                    <input type="text" class="form-control" name="letter_date" value="<?= ($caseHdrArray['letter_date'] == '00-00-0000' || $caseHdrArray['letter_date'] == '') ? date('d-m-Y') : $caseHdrArray['letter_date'] ?>" onChange="chkLetterDate(this); make_date(this)" <?= $redLetter ?>/>
                                <?php } else { ?>  
                        ...
                        <div class="mn-inpt-sec d-inline-block w-100 p-3">
                            <div class="all-inpt d-inline-block w-100">
                                ...
                                <!-- condition is applied in this field and used onDblClick="show_matter_history2()" function, for abhijit open lookup by history2 and for others history -->
                                    <label for="" class="d-block w-100 mb-2">Matter <strong class="text-danger">*</strong></label>
                                    <input type="text" class="form-control" name="matter_code" placeholder="Matter Code" oninput="this.value = this.value.toUpperCase();" id="matterCode" onfocusout="fetchData(this, 'matter_code', ['referenceDesc', 'clientCode', 'clientName', 'appearFor', 'judgeName', 'courtName', 'matterStatus'], ['reference_desc', 'client_code', 'client_name', 'appearing_for', 'judge_name', 'court', 'status_code'], 'matter_code'); showHistoryBtn(this, 'caseHistory'); getMatterValue(this)" value="<?= isset($caseHdrArray['matter_code']) ? $caseHdrArray['matter_code'] : '' ?>" <?= $redv ?> required/>
                                ...
                                <div class="inpts col-md-6 float-start px-2 position-relative mtop">
                                    <input type="text" class="form-control" name="mat_description" placeholder="Matter Description" readonly oninput="this.value = this.value.toUpperCase()" id="matterDesc"  value="<?= isset($caseHdrArray['full_matter_desc']) ? $caseHdrArray['full_matter_desc'] : '' ?>"/>
                                </div>
                            ...
                            <div class="all-inpt d-inline-block w-49 mt-0">
                                <div class="inpts col-md-3 float-start px-2">
                            ...
                            <div class="all-inpt d-inline-block w-50 mt-0">
                                <div class="inpts col-md-3 float-start px-2">
                            ...
                            <div class="all-inpt d-inline-block w-100 mt-0">
                                <div class="inpts col-md-12 float-start px-2">
                                    <textarea name="other_case_desc" id="" readonly rows="1" class="form-control w-100" placeholder="Other case description" <?= $permission ?>><?= isset($caseHdrArray['other_case_desc']) ? $caseHdrArray['other_case_desc'] : '' ?></textarea>
                                </div>
                            </div>
                            <div class="all-inpt d-inline-block w-100 mt-0">
                                <div class="inpts col-md-4 float-start px-2">
                                    <label for="" class="d-block w-100 mb-2">Appear For</label>
                                    <input type="text" class="form-control" placeholder="Appear For" name="appear_for" id="appearFor" readonly  value="<?= isset($caseHdrArray['appear_for']) ? $caseHdrArray['appear_for'] : '' ?>" />
                                </div>
                                <div class="inpts col-md-4 float-start px-2">
                                    <label for="" class="d-block w-100 mb-2">Fixed For</label>
                                    <textarea name="prev_fixed_for" id="prevFixedFor" rows="1" class="form-control w-100" placeholder="Fixed For" <?= $permission ?>><?= isset($caseHdrArray['prev_fixed_for']) ? $caseHdrArray['prev_fixed_for'] : '' ?></textarea> 
                                </div>
                                <div class="inpts col-md-4 float-start px-2">
                                    <label for="" class="d-block w-100 mb-2">Previous Remarks</label>
                                    <textarea name="last_remark" id="lastRemark" rows="1" class="form-control w-100" readonly  placeholder="Previous Remarks" <?= $redv ?>></textarea>
                                </div>
                            </div>
                            <div class="all-inpt d-inline-block w-100">
                                <div class="inpts col-md-3 float-start px-2">
                                ...
                                <div class="inpts col-md-3 float-start px-2 mt-1">
                                ...
                                <div class="inpts col-md-3 float-start px-2 mt-1">
                                    <label for="" class="d-block w-100 mb-2">Instrument Type <strong class="text-danger">*</strong></label>
                                ...
                                <div class="inpts col-md-3 float-start px-2 pe-0 mt-1">
                                ...
                                <div class="inpts col-md-5 float-start px-2 pe-0 mt-1">
                                    <label for="" class="d-block w-100 mb-2">Judge</label>
                                    <input type="text" class="form-control" placeholder="Judge Name" name="judge_name" id="judgeName" value="<?= ($option == 'add') ? '' : $caseHdrArray['judge_name'] ?>" <?= $redv ?>/>
                                </div>
                                <div class="inpts col-md-4 float-start px-2 pe-0 mt-1">
                                    <label for="" class="d-block w-100 mb-2">Next date</label>
                                    <input type="text" class="form-control" placeholder="Next date" id="nextDate" name="next_date" value="<?= ($option == 'add') ? '' : $caseHdrArray['next_date'] ?>" onchange="chkNextDate(this)" <?= $redv ?>/>
                                </div>
                                <div class="position-relative intrmde-dts d-inline-block col-md-12 border mt-5 py-2">   
                                    ...
                                    <div class="inpts w-50 float-start px-2 pe-0 mt-3 position-relative">
                                        <label for="" class="d-block w-100 mb-2">Fixed For <strong class="text-danger">*</strong></label>
                                        <textarea name="next_fixed_for" id="" rows="2" class="form-control" placeholder="Fixed For" <?= $redv ?> required><?= ($option == 'add') ? '' : $caseHdrArray['next_fixed_for'] ?></textarea>
                                    </div>
                                ...
                                <div class="inpts w-100 float-start px-2 mt-3">
                                    <label for="" class="d-block w-100 mb-2">Particulars <strong class="text-danger">*</strong></label>
                                    <textarea name="letter_body_desc" id="editor" rows="2" class="form-control" placeholder="Particulars" <?= $redv ?> required><?= ($option == 'add') ? '' : $caseHdrArray['header_desc'] ?></textarea>
                                </div>
                                <div class="inpts w-100 float-start px-2 mt-3">
                                    <label for="" class="d-block w-100 mb-2">Other Remarks <strong class="text-danger">*</strong></label>
                                    <textarea name="other_body_desc" id="" rows="1" class="form-control" placeholder="Other Remarks" <?= $redv ?> required><?= ($option == 'add') ? '' : $caseHdrArray['other_body_desc'] ?></textarea>
                                </div>
                                <div class="inpts col-md-4 float-start px-2 mt-1 h75">
                                ...
                                <div class="inpts col-md-4 float-start px-2 mt-1 h75">
                                    <label for="" class="d-block w-100 mb-2">Matter Status <strong class="text-danger">*</strong></label>
                                    <select name="matter_status" id="matterStatus" class="form-select" <?= $disview ?> required>
                                    <option value="">--Select--</option>
                                ...
                                <div class="inpts col-md-4 float-start px-2 mt-1">
                                ...
                                <div class="inpts col-md-4 float-start px-2 mt-1">
                                    ...
                                    <input type="text" class="form-control datepicker" placeholder="dd-mm-yyyy" onblur="make_date(this)" name="alert_date" value="<?= ($option == 'add') ? '' : $caseHdrArray['alert_date'] ?>" <?= $redv ?> />
                                </div>
                                <div class="inpts col-md-4 float-start px-2 mt-1">
                                ...
                                <div class="inpts col-md-12 float-start px-2 mt-1">
                                ...
                                <div class="d-inline-block w-100 px-2 mt-4">
                                    <div class="tbladd nobrdr-icn">
                                        ...
                                        <tbody id="tbody">
                                            ...
                                            ?>
                                            <tr>
                                                <td style="width:20px;" id="Ctd<?= $k ?>" onClick="<?php if ($option == 'edit' || $option == "add") { ?>delRow_inpocket(this, <?= $k ?>)<?php } ?>"><input type="hidden" class="cstm-rdo" value="Y" name="del_inpoc<?= $k ?>" id="del_inpoc<?= $k ?>" checked <?= $disview ?> onClick="<?php if ($option == 'edit' || $option == "add") { ?>delRow_inpocket(this, <?= $k ?>)<?php } ?>">
                    ...
                    // echo '<pre>';print_r($caseHdrArray['caseCounselArray']);die;
                                            ...
                                            <!-- disabled is putted dynamically -->
                                                <td id="Ctd2<?php echo $m; ?>" class="text-center" onClick="<?php if ($option == 'edit' || $option == "add") { ?>delRow_counsel(this, <?= $m ?>)<?php } ?>"><input type="hidden" class="cstm-rdo" value="Y" name="del_counsel<?php echo $m;?>" id="delCounsel<?php echo $m;?>" checked <?= $disview ?> onClick="<?php if ($option == 'edit' || $option == "add") { ?>delRow_counsel(this, <?= $m ?>)<?php } ?>">
                                                <img src="<?= base_url('public/assets/img/SelectRow.png') ?>" class="slctRow" alt="Select"/>
                                                </td>
                                                <td class="w-15">
                                                <div class="d-inline-block w-100 position-relative Inpt-Vw-icn">
                                                ...
                                                <td class="w-80"><input type="text" class="w-100 form-control" name="counsel_name<?php echo $m;?>" id="counselName<?php echo $m;?>" value="<?php echo $counsel_name;?>" readonly></td>
                                                <td class="w-15">
                                                <div class="d-inline-block w-100 position-relative Inpt-Vw-icn">
                                                ...
                                                <td class="w-80"><textarea class="w-100 resze form-control" rows="1" class="w-100" name="coun_desc<?php echo $m;?>" id="counDesc<?php echo $m;?>" readonly> <?php echo $activity_description;?> </textarea></td>
                                                <td class="text-center w-5"><input type="checkbox" class="cstm-rdo" name="pay<?php echo $m;?>" value="Y" <?php if($payable_ind == "Y") { echo "checked"; } ?> <?= $disview?> ></td>
                                                <td class="text-center TbladdBtn">
                                ...
                                <div class="inpts w-100 float-start px-2 mt-2">
    ...
    <?php } else if(isset($xQry) && !isset($qry)) { ?>
        <form action="" method="post" name="caseStatusLetter" id="caseStatusLetter" onsubmit="setCheckValue(event)">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 d-inline-block mb-3">
                            <button type="submit" class="btn btn-primary cstmBtn mt-3" onclick="formOption('/case/status/', 'print', 'caseStatusLetter')">Print</button>
                            <!--<button type="button" class="btn btn-primary cstmBtn btn-cncl mt-3 ms-2">Exit</button>-->
                            <a href="<?= base_url($data['requested_url']) ?>" class="btn-bck btn btn-dark mt-3 me-3">Back</a>
                        </div>
                ...
                <?php } else {?>
                    <?php 
                        ...
                        $page_flag = 'F';
                    ?>
                <div class="m-0 m-auto" style="width:750px;">
                    <table width="681" cellpadding="0" cellspacing="0" border="0" class="m-0 m-auto">
                        <?php if($params['logo_print_ind'] == 'Y') { ?>
                        <tr>
                    ...
                    <table width="681" cellpadding="0" cellspacing="0" border="0" class="m-0 m-auto">
                    <tr>
                    <td class="GroupDetail_band_portrait_1" width="40%" valign="top">
                    ...
                    <td class="GroupDetail_band_portrait_1" width="60%" valign="top"> 
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" vspace="0">
                            <tr>
                            <td height="20" width="10%" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify; font-size:13px; font:Verdana; font-family:Verdana;"><?php echo 'Re : '?></td>
                            <td height="20" width="90%" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify; font-size:13px; font:Verdana; font-family:Verdana;"><?php echo $params['matter_desc'];?></td>
                            </tr>
                            <tr>
                            <td height="70">&nbsp;</td>
    ...
    function addInpocketRow(fld,n) { 
        ...
        if(document.caseStatusForm.user_option.value == 'add' || document.caseStatusForm.user_option.value == 'edit') { 
            if(conditionFlag || total_row == 0) {
                ...
                var text1  = `
                    <tr>
                        <td class="text-center" id="Ctd${n}" onClick="<?php if ($option == 'edit' || $option == "add") { ?>delRow_inpocket(this, ${n})<?php } ?>"><input type="hidden" value="Y" name="del_inpoc${n}" id="del_inpoc${n}" title="Delete Row" onClick="<?php if ($option == 'edit' || $option == "add") { ?>delRow_inpocket(this, ${n})<?php } ?>">
                        <img src="<?= base_url('public/assets/img/SelectRow.png') ?>" class="slctRow" alt="Select"/>
                        </td>
                        <td><input class="w-100 resze form-control" type="text" name="asso_code${n}" value="0000" readonly></td>
                        <td><input class="w-100 resze form-control" type="text" name="asso_name${n}" value="OWN" readonly></td>
                        <td>
                            <div class="d-inline-block w-100 position-relative Inpt-Vw-icn">
                                <input class="w-100 resze form-control" type="text" name="asso_acty${n}" id="assoActy${n}" oninput="this.value = this.value.toUpperCase()" onchange="fetchData(this, 'activity_code', ['assoDesc${n}'], ['activity_desc'], 'activity_code')">
                        ...
                        <td><input class="w-100 resze form-control" type="text" name="asso_desc${n}" id="assoDesc${n}" readonly></td>
                        <td class="text-center TbladdBtn">&nbsp;<input type="button" name="Add_inpoc${n}" value="+" title="Add Row" onClick="addInpocketRow(this,${n})"> </td>
                    </tr>`;
    ...
    function addCounselRow(fld,n) {
        ...
        { 
            if(conditionFlag || total_row == 0) {
                ...
                var text2  =  `
                <tr>
                    <td class="text-center" id="Ctd2${n}" onClick="<?php if ($option == 'edit' || $option == "add") { ?>delRow_counsel(this, ${n})<?php } ?>"><input type="hidden" value="Y" name="del_counsel${n}" id="delCounsel${n}" onClick="<?php if ($option == 'edit' || $option == "add") { ?>delRow_counsel(this, ${n})<?php } ?>">
                    <img src="<?= base_url('public/assets/img/SelectRow.png') ?>" class="slctRow" alt="Select"/>
                    </td>
                    <td>
                        <div class="d-inline-block w-100 position-relative Inpt-Vw-icn">
                            <input class="w-100 resze form-control" type="text" name="counsel_code${n}" id="counselCode${n}" oninput="this.value = this.value.toUpperCase()" onchange="fetchData(this, 'associate_code', ['counselName${n}'], ['associate_name'], 'counsel_code')">
                    ...
                    <td><input class="w-100 resze form-control" type="text" name="counsel_name${n}" id="counselName${n}" readonly=true></td>
                    <td>
                        <div class="d-inline-block w-100 position-relative Inpt-Vw-icn">
                            <input class="w-100 resze form-control" type="text" name="coun_acty${n}" id="counActy${n}" oninput="this.value = this.value.toUpperCase()" onchange="fetchData(this, 'activity_code', ['counDesc${n}'], ['activity_desc'], 'activity_code')">
                    ...
                    <td><input class="w-100 resze form-control" type="text" name="coun_desc${n}" id="counDesc${n}" readonly=true></td>
                    <td><input class="w-100" type="checkbox" name="pay${n}" value="Y"></td>
                    <td class="text-center TbladdBtn"><input type="button" name="Add_coun${n}" value="+" title="Add Row" onClick="addCounselRow(this,${n})"></td>
                </tr>`;
