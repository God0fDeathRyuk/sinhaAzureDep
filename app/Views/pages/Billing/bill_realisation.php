        ...
        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>">
			<div class="frms-sec d-inline-block w-100 bg-white p-3">
					<div class="frms-sec-insde d-block float-start col-md-12 px-2 mb-4">
						...
						<select class="form-select cstm-inpt w-25" name="branch_code">
					...
					<div class="frms-sec-insde d-block float-start col-md-6 ps-2 mb-4">
						...
						<input type="text" class="form-control float-start w-40 ms-2 set-date datepicker" id="" placeholder="dd-mm-yyyy" name="realisation_start_date" onBlur="make_date(this)" />
						<span class="float-start mt-2 ms-2">To</span>
						<input type="text" class="form-control float-start w-40 ms-2 set-date datepicker withdate" id="" placeholder="dd-mm-yyyy" name="realisation_end_date" onBlur="make_date(this)" />
					</div>
                    <div class="frms-sec-insde d-block float-start col-md-6 ps-2 mb-4">
						<label class="d-inline-block w-100 mb-2 lbl-mn">Billing Period</label>
						<span class="float-start mt-2">From</span>
						<input type="text" class="form-control float-start w-40 ms-2 set-date datepicker" id="" placeholder="dd-mm-yyyy" name="billing_start_date" onBlur="make_date(this)" />
						<span class="float-start mt-2 ms-2">To</span>
						<input type="text" class="form-control float-start w-40 ms-2 set-date datepicker withdate" id="" placeholder="dd-mm-yyyy" name="billing_end_date" onBlur="make_date(this)" />
					</div>
    ...
    <script>
        ...
        <?php if(($params['info_by'] == 'B') && ($params['report_type'] == 'D')){
            if ($params['report_seqn'] == 'B') 
            {
                ...
                ?>
                    <table class="table border-0 px-2" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color:#f6f9ff;">
                        ...
                        <tr class=""><td align="left" class="p-2 border-0">&nbsp;</td></tr>
                        <tr class="fs-14">
                            <th width="" align="left"  class="py-3 px-2">Bill No</th>
                            <th width="" align="left"  class="py-3 px-2">Bill Dt</th>
                            <th width="" align="left"  class="py-3 px-2">Client/Matter</th>
                            <th width="" align="left"  class="py-3 px-2">Intl</th>
            ...
            else if ($params['report_seqn'] == 'C') 
            {
                ...
                <?php
                        ...
                        $pageno = $pageno + 1 ;
                ?>
                    <table width="100%" class="px-2" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color:#f6f9ff;">
                        <tr>
                            <td colspan="6">    
                                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                        ...
                        <tr class="fs-14">
                            <th width="" align="left"  class="py-3 px-2">Bill No</th>
                            <th width="" align="left"  class="py-3 px-2">Bill Dt</th>
                            <th width="" align="left"  class="py-3 px-2">Matter</th>
                            <th width="" align="left"  class="py-3 px-2">Intl</th>
                            <th width="" align="right" class="py-3 px-2">Realised&nbsp;</th>
                            <th width="" align="right" class="py-3 px-2">Deficit&nbsp;</th>
                        </tr>
                ...
                ?>
                                    <tr class="fs-14">
                                        <td align="left" class="p-2" colspan="6"><b><?php echo $plevelnm?></b></td> 
                                    </tr>
                                    <tr class="fs-14">
                ...
                ?>
                                    ...
                                    <tr class="fs-14">
                                        <td align="left"  class="p-2" colspan="4" style="background-color:#80adec;"><b>** Total</b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#80adec;"><b><?php if($lrealamt > 0) { echo number_format($lrealamt,2,'.',''); }?></b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#80adec;"><b><?php if($ldefcamt > 0) { echo number_format($ldefcamt,2,'.',''); }?></b>&nbsp;</td>
                                    </tr>
                <?php
                        $lineno   = $lineno + 2;
                ...
                ?>                   
                                    ...
                                    <tr class="fs-14">
                                        <td align="center" class="px-2" colspan="4" style="background-color:#fbfcce;"><b> GRAND TOTAL </b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#fbfcce;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#fbfcce;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                                    </tr>
                            </table>
                            </td>
                        </tr>
            ...
            else if ($params['report_seqn'] == 'M') 
            {
                ...
                ?>
                    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" class="px-2" style="background-color:#f6f9ff;">
                        ...
                        <tr class="fs-14">
                            <th width="" align="left"  class="py-3 px-2">Bill No</th>
                            <th width="" align="left"  class="py-3 px-2">Bill Dt</th>
                            <th width="" align="left"  class="py-3 px-2">Client</th>
                            <th width="" align="left"  class="py-3 px-2">Intl</th>
                            <th width="" align="right" class="py-3 px-2">Realised&nbsp;</th>
                            <th width="" align="right" class="py-3 px-2">Deficit&nbsp;</th>
                        </tr>   
                ...
                ?>                   
                                    ...
                                    <tr class="fs-14">
                                        <td align="center" class="p-2" colspan="4" style="background-color:#fbfcce;vertical-align:middle;"><b>*** GRAND TOTAL ***</b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#fbfcce;vertical-align:middle;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#fbfcce;vertical-align:middle;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                                    </tr>
                            </table>
                            </td>
                        </tr>
            ...
            else if ($params['report_seqn'] == 'I') 
            {
                ...
                <?php
                        ...
                        $pageno = $pageno + 1 ;
                ?>
                    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color:#f6f9ff;">
                        <tr>
                            <td colspan="5">    
                                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                        ...
                        <tr class="fs-14">
                            <th width="100" align="left"  class="py-3 px-2">Bill No</th>
                            <th width="075" align="left"  class="py-3 px-2">Bill Dt</th>
                            <th width="575" align="left"  class="py-3 px-2">Client/Matter</th>
                ...
                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" class="p-2"><b><?php if($lrealamt > 0) { echo number_format($lrealamt,2,'.',''); }?></b>&nbsp;</td>
                                        <td align="right" class="p-2"><b><?php if($ldefcamt > 0) { echo number_format($ldefcamt,2,'.',''); }?></b>&nbsp;</td>
                                    </tr>
                <?php
                        $lineno   = $lineno + 2;
                        $trealamt = $trealamt + $lrealamt ;
                ...
                ?>                   
                                    ...
                                    <tr>
                                        <td align="center" class="p-2" colspan="3"><b>*** GRAND TOTAL ***</b>&nbsp;</td>
                                        <td align="right"  class="p-2"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                        <td align="right"  class="p-2"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                                    </tr>
                            </table>
                            </td>
                        </tr>
            ...
            else if ($params['report_seqn'] == 'T') 
            {
                ...
                <?php
                        ...
                        $pageno = $pageno + 1 ;
                ?>
                    <table width="100%" align="center" border="0" cellspacing="0" class="px-2" cellpadding="0" style="background-color:#f6f9ff;">
                        <tr>
                            <td colspan="5">    
                                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                ...
                ?>
                                    ...
                                    <tr class="fs-14">
                                        <td align="left"  class="p-2" colspan="3" style="background-color:#80adec;"><b>** Total</b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#80adec;"><b><?php if($lrealamt > 0) { echo number_format($lrealamt,2,'.',''); }?></b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#80adec;"><b><?php if($ldefcamt > 0) { echo number_format($ldefcamt,2,'.',''); }?></b>&nbsp;</td>
                                    </tr>
                <?php
                ...
                ?>                   
                                    ...
                                    <tr class="fs-14">
                                        <td align="center" class="p-2" colspan="3" style="background-color:#fbfcce;"><b>*** GRAND TOTAL ***</b>&nbsp;</td>
                                        <td align="right"  class="p-2" style="background-color:#fbfcce;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                        <td align="right"  class="p-2" style="background-color:#fbfcce;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                                    </tr>
                            </table>
        ...
        <?php if(($params['info_by'] == 'B') && ($params['report_type'] == 'S')){
            if ($params['report_seqn'] == 'C') 
            {
                ...
                ?>
                    <table class="table border-0 px-2" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color:#f6f9ff;">
                        <tr>
                            <td class="border-0 pb-0" colspan="4">    
                                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="fs-14">
                        ...
                        <th width="" align="left" class="py-3 px-2">Realised&nbsp;</th>
                        <th width="" align="left" class="py-3 px-2">Deficit&nbsp;</th>
                    </tr>
                    ...
                    ?>                   
                                ...
                                <tr class="fs-14">
                                    <td align="center" class="p-2" colspan="2" style="background-color:#fbfcce;"><b> GRAND TOTAL </b>&nbsp;</td>
                                    <td align="right"  class="p-2" style="background-color:#fbfcce;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                    <td align="right"  class="p-2" style="background-color:#fbfcce;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                                </tr>
                        </table>
            ...
            else if ($params['report_seqn'] == 'M') 
            {
                ...
                <?php
                        ...
                        $pageno = $pageno + 1 ;
                ?>
                <table class="table border-0" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color:#f6f9ff;">
                    <tr>
                ...
                ?>
                            <tr class="fs-14">
                                <td align="left"  class="py-3 px-2"><?php echo $report_row['matter_code']?></td> 
                                <td align="left"  class="py-3 px-2"><?php echo strtoupper($report_row['matter_desc'])?></td>
                            ...
                            <tr>
                                ...
                                <td align="left"  class="py-3 px-2"><?php echo strtoupper($report_row['client_name'])?></td>
                                <td align="right" class="py-3 px-2">&nbsp;</td>
                                <td align="right" class="py-3 px-2">&nbsp;</td>
                            </tr>
                <?php     
                        $lineno   = $lineno  + 2;
                ...
                ?>                   
                            ...
                            <tr class="fs-14">
                                <td align="center" class="py-3 px-2" colspan="2" style="background-color: #94c0cf;"><b>GRAND TOTAL</b>&nbsp;</td>
                                <td align="right"  class="py-3 px-2" style="background-color: #94c0cf;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                <td align="right"  class="py-3 px-2" style="background-color: #94c0cf;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                            </tr>
                    </table>
                    </td>
                </tr>
            ...
            else if ($params['report_seqn'] == 'I') 
            {
                ...
                ?>
                            <tr class="fs-14">
                                <td align="left"  class="py-3 px-2"><?php echo $report_row['initial_code']?></td> 
                                <td align="left"  class="py-3 px-2"><?php echo strtoupper($report_row['initial_name'])?></td>
                                <td align="right" class="py-3 px-2"><?php if($realamt > 0) { echo number_format($realamt,2,'.',''); }?>&nbsp;</td>
                                <td align="right" class="py-3 px-2"><?php if($defcamt > 0) { echo number_format($defcamt,2,'.',''); }?>&nbsp;</td>
                            </tr>
                <?php     
            ...
            else if ($params['report_seqn'] == 'T') 
            {
                ...
                <table class="table border-0" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color:#f6f9ff;">
                    ...
                    ?>
                                <tr class="fs-14">
                                    <td align="left"  class="py-3 px-2"><?php echo $report_row['court_code']?></td> 
                                    <td align="left"  class="py-3 px-2"><?php echo strtoupper($report_row['court_name'])?></td>
                                    <td align="left" class="py-3 px-2"><?php if($realamt > 0) { echo number_format($realamt,2,'.',''); }?>&nbsp;</td>
                                    <td align="left" class="py-3 px-2"><?php if($defcamt > 0) { echo number_format($defcamt,2,'.',''); }?>&nbsp;</td>
                                </tr>
                    <?php     
                            $lineno   = $lineno  + 1;
                            $trealamt = $trealamt + $realamt ;
                    ...
                    ?>                   
                                ...
                                <tr class="fs-14">
                                    <td align="center" class="py-3 px-2" colspan="2"  style="background-color: #94c0cf;"><b> GRAND TOTAL </b>&nbsp;</td>
                                    <td align="left"  class="py-3 px-2" style="background-color: #94c0cf;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                    <td align="left"  class="py-3 px-2" style="background-color: #94c0cf;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                                </tr>
                        </table>
                    </td>
                </tr>
        ...
        <?php if(($params['info_by'] == 'C') && ($params['report_type'] == 'D')){
            if ($params['report_seqn'] == 'B') 
            {
                ...
                <tr class="fs-14">
                    ...
                    <th width="" align="left"  class="py-3 px-2">Client/Matter</th>
                    <th width="" align="left"  class="py-3 px-2">Intl</th>
                    <th width="" align="left"  class="py-3 px-2">Rl. Date&nbsp;</th>
                    <th width="" align="left" class="py-3 px-2">Realised&nbsp;</th>
                    <th width="" align="left" class="py-3 px-2">Deficit&nbsp;</th>
                </tr>
                ...
                ?>                   
                            ...
                            <tr>
                                <td align="center" class="report_detail_bottom" colspan="7" style="background-color:#fbfcce;"><b>*** GRAND TOTAL ***</b>&nbsp;</td>
                                <td align="right" class="report_detail_bottom" style="background-color:#fbfcce;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                <td align="right" class="report_detail_bottom" style="background-color:#fbfcce;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                            </tr>
                    </table>
                    </td>
                </tr>
            ...
            else if ($params['report_seqn'] == 'C') 
            {
                ...
                ?>
                        <tr>
                            <td align="left"  class="p-2"><?php echo $slevelcd1 ; ?></td> 
                            <td align="left"  class="p-2"><?php echo date_conv($slevelcd2); ?></td> 
                            <td align="left"  class="p-2" colspan="2"><?php echo $slevelcd3 ; ?></td> 
                            <td align="right" class="p-2" colspan="3"><b>** Instrument Total</b>&nbsp;</td>
                            <td align="right" class="p-2"><b><?php if($srealamt > 0) { echo number_format($srealamt,2,'.',''); }?></b>&nbsp;</td>
                            <td align="right" class="p-2"><b><?php if($sdefcamt > 0) { echo number_format($sdefcamt,2,'.',''); }?></b>&nbsp;</td>
                            </tr>
                            <tr>
                            <td colspan="8">&nbsp;</td>
                            </tr>
                ...
                ?>
                            ...
                            <tr>
                            <td align="left"  class="p-2" colspan="7" style="background-color:#80adec;"><b>** Total</b>&nbsp;</td>
                            <td align="right" class="p-2" style="background-color:#80adec;"><b><?php if($lrealamt > 0) { echo number_format($lrealamt,2,'.',''); }?></b>&nbsp;</td>
                            <td align="right" class="p-2" style="background-color:#80adec;"><b><?php if($ldefcamt > 0) { echo number_format($ldefcamt,2,'.',''); }?></b>&nbsp;</td>
                            </tr>
                <?php
                ...
                ?>                   
                            ...
                            <tr>
                            <td align="center" class="p-2" colspan="7" style="background-color:#fbfcce;"><b>*** GRAND TOTAL ***</b>&nbsp;</td>
                            <td align="right" class="p-2" style="background-color:#fbfcce;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                            <td align="right" class="p-2" style="background-color:#fbfcce;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                            </tr>
                    </table>
            ...
            else if ($params['report_seqn'] == 'M') 
            {
                ...
                <?php
                            ...
                            $pageno = $pageno + 1 ;
                ?>
                <table width="100%" align="center" class="px-2"  style="background-color:#f6f9ff;" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="9">    
                        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                ...
                ?>
                            <tr class="fs-14">
                                <td align="left" class="p-2" colspan="9"><b><?php echo $plevelnm?></b></td> 
                            </tr>
                            <tr class="fs-14">
                                <td align="left" class="p-2" colspan="9">&nbsp;</td>
                            </tr>
                <?php
                            $lineno = $lineno + 2 ;
                            $plevelind = 'N' ;
                ...
                <tr>
                    <td colspan="9">    
                        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td class="report_label_text" colspan="4" align="center"><b>Sinha and Companyvv</b></td>
                            </tr>
                            <tr>
                                <td class="report_label_text" colspan="4" align="center"><b><u> <?php echo strtoupper($params['report_desc'])?> </u></b></td>
                            </tr>
            ...
            else if ($params['report_seqn'] == 'T') 
            {
                ...
                if ($lineno == 0 || $lineno > $maxline)
                {
                    ...
                    <?php
                                ...
                                $pageno = $pageno + 1 ;
                    ?>
                <table width="100%" align="center" class="px-2" border="0" cellspacing="0" cellpadding="0" style="background-color:#f6f9ff;">
                <tr>
                    <td colspan="9">    
                        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                ...
                ?>
                            ...
                            <tr class="fs-14">
                                <td align="right"  class="report_detail_bottom" colspan="7"><b>Total</b>&nbsp;</td>
                                <td align="right" class="p-2"><b><?php if($lrealamt > 0) { echo number_format($lrealamt,2,'.',''); }?></b>&nbsp;</td>
                                <td align="right" class="p-2"><b><?php if($ldefcamt > 0) { echo number_format($ldefcamt,2,'.',''); }?></b>&nbsp;</td>
                            </tr>
                <?php
        ...
        <?php if(($params['info_by'] == 'C') && ($params['report_type'] == 'S')){
            if ($params['report_seqn'] == 'B') 
            {
                ...
                <tr class="fs-14">
                    <th width="" align="left"  class="py-3 px-2">Chq No</th>
                    <th width="" align="left"  class="py-3 px-2">Chq Dt</th>
                    <th width="" align="left"  class="py-3 px-2">Bank Name</th>
                ...
                ?>                   
                            ...
                            <tr class="fs-14">
                                <td align="center" class="py-3 px-2" colspan="4" style="background-color:#f0f1a4;"><b> GRAND TOTAL </b>&nbsp;</td>
                                <td align="left"  class="py-3 px-2" style="background-color:#f0f1a4;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                <td align="left"  class="py-3 px-2" style="background-color:#f0f1a4;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                            </tr>
                    </table>
                    </td>
                </tr>
            ...
            else if ($params['report_seqn']== 'C') 
            {
                ...
                ?>                   
                                    ...
                                    <tr class="fs-14">
                                        <td align="center" class="p-2" colspan="4" style="background-color:#fbfcce;"><b>*** GRAND TOTAL ***</b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#fbfcce;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                        <td align="right" class="p-2" style="background-color:#fbfcce;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                                    </tr>
                            </table>
            ...
            else if ($params['report_seqn'] == 'M') 
            {
                        ...
                        <tr>
                            <td class="border-0 pb-0" colspan="6">    
                                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                    <td class="report_label_text" colspan="4" align="center"><b>Sinha and Companyooo</b></td>
                                    </tr>
                                    <tr>
                                    <td class="report_label_text" colspan="4" align="center"><b><u> <?php echo strtoupper($params['report_desc'])?> </u></b></td>
                                    </tr>
                ...
                ?>                   
                                    ...
                                    <tr>
                                    <td align="center" class="report_detail_bottom" colspan="4" style="background-color:#fbfcce;"><b>*** GRAND TOTAL ***</b>&nbsp;</td>
                                    <td align="right" class="report_detail_bottom" style="background-color:#fbfcce;"><b><?php if($trealamt > 0) { echo number_format($trealamt,2,'.',''); }?></b>&nbsp;</td>
                                    <td align="right" class="report_detail_bottom" style="background-color:#fbfcce;"><b><?php if($tdefcamt > 0) { echo number_format($tdefcamt,2,'.',''); }?></b>&nbsp;</td>
                                    </tr>
                            </table>
