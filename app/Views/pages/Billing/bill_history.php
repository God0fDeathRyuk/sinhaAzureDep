...
<td class="cellheight_1" width="" colspan="6">
        ...
        <tr>
          ...
          <td class="ReportColumn_portrait w-20">&nbsp;<?= $hdr_row['serial_no']?></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td class="GroupDetail_band_portrait w-20">&nbsp;<?= $hdr_row['bill_date'] ?></td>
      ...
      <div class="tblmn2">
        <table width="750" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <!-- client detail -->
            <td width="425" height="180" style="vertical-align:text-top">
              <table width="100%"  cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td height="15" class="GroupDetail_band_portrait">&nbsp;<?= $bill_data['client_name']?></td>
                </tr>
                <tr>
                  <td height="15" class="GroupDetail_band_portrait">&nbsp;<?= $cadr_row['address_line_1']?></td>
                </tr>
                <?php if(!empty($cadr_row['address_line_2'])) { ?>              
                <tr>
                  <td height="15" class="GroupDetail_band_portrait">&nbsp;<?= $cadr_row['address_line_2']?></td>
                </tr>
                <?php } if(!empty($cadr_row['address_line_3'])) { ?>              
                <tr>
                  <td height="15" class="GroupDetail_band_portrait">&nbsp;<?= $cadr_row['address_line_3']?></td>
                </tr>
                <?php } if(!empty($cadr_row['address_line_4'])) { ?>              
                <tr>
                  <td height="15" class="GroupDetail_band_portrait">&nbsp;<?= $cadr_row['address_line_4']?></td>
                </tr>
                <?php } ?>              
                <tr>
                  <td height="15" class="GroupDetail_band_portrait">&nbsp;<?= $cadr_row['city'] .' '.$cadr_row['pin_code']?></td>
                </tr>
                <tr>
                  <td height="90" class="GroupDetail_band_portrait">&nbsp;<?= 'Attn. : '.$bill_data['attention_name']?></td>
                </tr>
              </table>
            </td>
            ...
            <td width="350">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="20" width="06%" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?= 'Re : '?></td>
                  <td height="20" width="94%" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?= $bill_data['matter_name']?></td>
                </tr>
                <tr>
                <td>&nbsp;</td>
                  <td height="70" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?= '     ' . $bill_data['other_case_desc']?></td>
                </tr>
                <tr>
                  <td height="15" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?php if($hdr_row['source_code'] == 'C') { echo ' ' ; } else { echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' ; }?></td>
                  <td height="15" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?= stripslashes($hdr_row['reference_desc'])?></td>
                </tr>
                <tr>
                  <td class="GroupDetail_band_portrait w-10" style="vertical-align:text-top; text-align:justify; font:Courier;">Sub :&nbsp;</td>
                  <td height="75" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?php echo stripslashes($hdr_row['subject_desc'])?></td>
                </tr>
              </table>
            </td>
            <!-- end of ref and subj -->
      ...
      <table width="750" cellpadding="0" cellspacing="0" border="1" bordercolor="#666" bordercolordark="#FFFFFF" bordercolorlight="#FFFFFF">
      <tr>
      <td>
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          ...
          <td class="GroupDetail_band_portrait" width="100" align="right"><b class="pe-2 tblTplst">In-pocket (<img src="<?= base_url('public/assets/img/rupee.jpg') ?>" height="8" border="0">)</b>&nbsp;</td>
          <td class="GroupDetail_band_portrait" align="right"><b class="pe-2 tblTplst">Out-pocket (<img src="<?= base_url('public/assets/img/rupee.jpg') ?>" height="8" border="0">)</b>&nbsp;</td>
        </tr>
<?php
      $l_no = 16;
      $tot_inp_amount  = 0;
...
?>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td class="GroupDetail_band_portrait" width="100">&nbsp;<b class="ps-3">Date</b></td>
              <td class="GroupDetail_band_portrait" width="400"><b class="ps-3">Details</b></td>
              <td class="GroupDetail_band_portrait" width="100" align="right"><b class="pe-2 tblTplst">In-pocket (<img src="./images/rupee.jpg" height="8" border="0">)</b>&nbsp;</td>
...
?>
         ...
         <tr>
           <td class="GroupDetail_band_portrait" style="vertical-align:text-top; font:Courier; font-family:Courier;"><b class="d-inline-block w125 ps-2"><?php echo $activity_date;?></b></td>
