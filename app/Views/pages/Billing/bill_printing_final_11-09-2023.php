      ...
      <div class="frms-sec d-inline-block w-100 bg-white p-3">
          <div class="d-inline-block w-100">
              ...
              <div class="frms-sec-insde d-block float-start col-md-2 px-2 mb-4">
                  ...
                  <select class="form-select" name="client_matter" onchange="selectLookup(this)">
          ...
          <div class="col-md-3 float-start px-2 ps-0 mb-3">
              ...
              <input type="text" placeholder="dd-mm-yyyy"  class="form-control float-start w-100 ms-2 set-date datepicker withdate" name="final_bill_date"  id="finalBillDate"/>
          </div>
          <div class="col-md-3 float-start px-2 position-relative mb-3">
              <label class="d-inline-block w-100 mb-2 lbl-mn">Format</label>
              <select class="form-select" name="bill_format" id="billFormat" readonly>
    ...
    <input type="hidden" id="bill_count" value="<?= $params['bill_cnt']?>" >
                <div class="d-inline-block w-100 mt-4">
                  ...
                  <td>
									...
									<td>
                    <input type="checkbox" class="" id="print_ind<?php echo $key+1?>" name="print_ind<?php echo $key+1?>" value="Y" >
									</td>
                  <td>
              ...
              <input type="hidden" name="bill_str" id="bill_str" size="2" value='' readonly>
					...
					<div class="d-block w-100 mt-1">
						<button type="submit" class="btn btn-primary cstmBtn mt-3 float-start" onclick="formOption('/billing/printing-final/', 'laser', 'billPrintingFinal');data_check('W')">Laser</button>
						<button type="button" class="btn btn-primary cstmBtn mt-3 float-start ms-2" >Dot Matri</button>
						<button type="button" class="btn btn-primary cstmBtn mt-3 float-start ms-2" >PDF</button>
						<button type="button" class="btn btn-primary cstmBtn mt-3 float-start ms-2">Back</button>
  ...
  <form action="" method="post" id="">
      ...
      <table width="750" cellpadding="0" cellspacing="0" border="0">
        ...
        ?> -->
          ...
          <tr>
            <td class="GroupDetail_band_portrait w-15">&nbsp;<?php if($params['prop_ind'] != 'on') { echo 'Bill No' ; } else { echo 'Ref No' ; }?></td>
            <td class="ReportColumn_portrait w-20">&nbsp;<?php echo $bill_row['fin_year'].'/'.$bill_row['bill_no'];?></td>
          </tr>
          <tr>
            <td class="GroupDetail_band_portrait w-15">&nbsp;<?php if($params['prop_ind'] != 'on') { echo 'Bill Date' ; } else { echo 'Ref Date' ; }?></td>
            <td class="ReportColumn_portrait w-20">&nbsp;<?php if(empty($params['final_bill_date'])) echo $bill_row['bill_date']; else echo $params['final_bill_date'];?></td>
            <td class="ReportTitle_portrait" align="center"><font size="+1"><b><?php if($params['dupl_ind']=='on') {echo 'DUPLICATE ';} if($params['revd_ind']=='on') {echo 'REVISED ';} if($params['prop_ind']=='on') {echo 'PROPOSE / QUOTATION ';} if($params['copy_ind']=='on') {echo 'COPY ';}?>BILL</b></font></td>
      ...
      <div class="tblmn2">
        <table width="750" cellpadding="0" cellspacing="0" border="0">
            ...
            <?php if ($bill_row['client_code'] == 'K00068') { ?>
                    <tr>
                    <td height="15" class="GroupDetail_band_portrait"><?php echo 'THE CHIEF LAW OFFICER'?></td>
                    </tr>
            <?php } ?>
            <?php if($params['trust_name'] != '') {?>
                        <tr>
                            <td height="15" class="GroupDetail_band_portrait">&nbsp;<?php echo $trust_name;?></td>
                        </tr>
            <?php } ?>
            <?php if(!empty($params['client_name'])) { ?> 
                        <tr>
                            <td height="15" class="GroupDetail_band_portrait">&nbsp;<?php echo $params['client_name'];?></td>
                        </tr>
            <?php } ?>
                  <tr>
                    <td height="15" class="GroupDetail_band_portrait">&nbsp;<?php echo $cadr_row['address_line_1'];?></td>
                  </tr>
                  <?php if(!empty($cadr_row['address_line_2'])) { ?>              
                  <tr>
                    <td height="15" class="GroupDetail_band_portrait">&nbsp;<?php echo $cadr_row['address_line_2'];?></td>
                  </tr>
                  <?php } if(!empty($cadr_row['address_line_3'])) { ?>              
                  <tr>
                    <td height="15" class="GroupDetail_band_portrait">&nbsp;<?php echo $cadr_row['address_line_3'];?></td>
                  </tr>
                  <?php } if(!empty($cadr_row['address_line_4'])) { ?>              
                  <tr>
                    <td height="15" class="GroupDetail_band_portrait">&nbsp;<?php echo $cadr_row['address_line_4'];?></td>
                  </tr>
                  <?php } ?>              
                  <tr>
                    <td height="15" class="GroupDetail_band_portrait">&nbsp;<?php echo $cadr_row['city'] .' '.' - '.$cadr_row['pin_code'];?></td>
                  </tr>
            <?php if($params['pan_no'] != '') {?>
                  <tr>
                    <td height="15" class="GroupDetail_band_portrait">&nbsp;<b><?php echo 'PAN : ' .' '.$params['pan_no'];?></b></td>
                  </tr>
            <?php } ?>

            <?php if($params['state_name'] != '') {?>
                  <tr>
                    <td height="15" class="GroupDetail_band_portrait">&nbsp;<b><?php echo strtoupper(stripslashes($params['state_name']));?></b></td>
                  </tr>
            <?php }  ?>
            <?php if($bill_row['b_d'] >= '2017-07-01' || date_conv($params['final_bill_date']) >= '2017-07-01') {?>	
                
                    <?php if($params['client_gst'] != '') {?>
                    <tr>
                        <td height="15" class="GroupDetail_band_portrait">&nbsp;<b><?php echo 'STATE CODE : ' .' '.strtoupper(stripslashes($params['gst_zone_code']));?></b></td>
                    </tr>
                    <?php } ?>

                    <?php if($params['client_gst'] != '') {?>
                    <tr>
                        <td height="15" class="GroupDetail_band_portrait">&nbsp;<b><?php echo 'GSTIN : ' .' '.strtoupper(stripslashes($params['client_gst'])) ;?></b></td>
                    </tr>
                    <?php } ?>

            <?php } ?>
      
            <?php if ($bill_row['attention_code'] != '373') { ?>

                        <tr>
                            <td valign="middle" height="90" class="GroupDetail_band_portrait">&nbsp;
                            <p>&nbsp;<?php if ($bill_row['attention_code'] != '0') echo 'Attn. : '.$params['attention_name'];?></p>
                            <p>&nbsp;<?php if($params['designation']!='') echo 'Designation : '.$params['designation']; else echo' ';?></p></td>
                        </tr>
            <?php } ?>
          ...
          <?php if($bill_row['fin_year'] == '2015-2016' && $bill_row['bill_no'] == 'GR71') { ?>
                  <tr>
          ...
          <?php } ?>  
                  <tr>
                    ...
                    <td height="20" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?php echo $params['matter_name'];?></td>
                  </tr>
                  <tr>
                    <td height="70">&nbsp;</td>
                    <td height="70" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?php echo $params['other_case_desc'];?></td>
                  </tr>
                  <tr>
                    <td height="15" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?php if($params['source_code']=='C') { echo ' ' ; } else { echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' ; }?></td>
                    <td height="15" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?php echo $params['reference_desc'];?></td>
                  </tr>
                  <tr>
                    <td height="75" class="GroupDetail_band_portrait w-15" style="vertical-align:text-top; text-align:justify;">Sub : &nbsp;</td>
                    <td height="75" class="GroupDetail_band_portrait" style="vertical-align:text-top; text-align:justify;"><?php echo strtoupper($params['subject_desc']);?></td>
                  </tr>
                </table>
              </td>
              <!-- end of ref and subj -->
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td class="GroupDetail_band_portrait">&nbsp;<b>Date</b></td>
              <td class="GroupDetail_band_portrait">&nbsp;<b>Details</b></td>
                  <td class="GroupDetail_band_portrait" width="" align="right"><b style="font-size:15px;">Professional Fees<b>(<span  class="style1"></span>)</b><br>
                  </b>&nbsp;</td>
                  <td class="GroupDetail_band_portrait" width="" align="right"><b>Reimbursement<b>(<span class="style1"></span>)</b><br>
                  </b>&nbsp;</td>
            ...
            <?php
                ...
                while($rowcnt <= $params['selecnt_nos'])
                {
                    $sub_inp_amount  = 0;
                    $sub_out_amount  = 0;
                    $sub_srv_amount  = 0;
                    ...
                    if ($params['service_tax_amount'] >0)
                    $pserv_tax_desc = $dtl_row['service_tax_desc'];
                    else
                    $pserv_tax_desc = '';

                    while($pserv_tax_ind == $dtl_row['service_tax_ind'] && $rowcnt <= $params['selecnt_nos'])
                    {
                    ...
                    if($l_no>$params['tot_no_of_lines'])
                    {
                    $page_no = $page_no + 1;
                    $l_no = 15;
            ?>
      ...
      <table width="750" cellpadding="0" cellspacing="0" border="0">
        ...
        ?>
          ...
          <tr>
            <td class="GroupDetail_band_portrait">&nbsp;<?php if($params['prop_ind'] != 'on') { echo 'Bill No' ; } else { echo 'Ref No' ; }?></td>
            <td class="ReportColumn_portrait">&nbsp;<?php echo $bill_row['fin_year'].'/'.$bill_row['bill_no'];?></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td> 
          </tr>
          <tr>
            <td class="GroupDetail_band_portrait">&nbsp;<?php if($params['prop_ind'] != 'on') { echo 'Bill Date' ; } else { echo 'Ref Date' ; }?></td>
            <td class="ReportColumn_portrait">&nbsp;<?php if(empty($params['final_bill_date'])) echo $bill_date; else echo $params['final_bill_date'];?></td>
            <td class="ReportTitle_portrait" align="center"><font size="+1"><b><?php if($params['dupl_ind']=='on') {echo 'DUPLICATE ';} if($params['revd_ind']=='on') {echo 'REVISED ';} if($params['prop_ind']=='on') {echo 'PROPOSE / QUOTATION ';} ?>BILL</b></font></td>
            <td>&nbsp;</td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr> 
                <td class="GroupDetail_band_portrait">&nbsp;<b>Date</b></td>
                <td class="GroupDetail_band_portrait">&nbsp;<b>Details</b></td>
                <td class="GroupDetail_band_portrait" align="right"><b style="font-size:15px;">Professional Fees <b>(<img src="./images/rupee.jpg" height="8" border="0">)</b><br>
                </b>&nbsp;</td>
                <td class="GroupDetail_band_portrait" align="right"><b>Reimbursement<b>(<img src="./images/rupee.jpg" height="8" border="0">)</b><br>
                </b>&nbsp;</td>
              </tr>
              <tr>
          ...
          <?php
                  ...
                  $activity_desc = text_justify(trim(nl2br(stripslashes($activity_desc))),$params['tot_char']);
          ...
          <tr>
            <td class="GroupDetail_band_portrait w-25" style="vertical-align:middle; font:Courier; font-family:Courier;"><b class="d-inline-block w125"><?php echo $activity_date ;?></b></td>
            <td class="GroupDetail_band_portrait" style="font:Courier; font-family:Courier; border-left-width: 1px; border-left-style: solid;  border-left-color: #666666;">&nbsp;<b style="width: 370px;padding:0 8px; display: inline-block; word-break: break-all;"><?php echo $activity_desc;?></b>&nbsp;</td>
      ...
      <tr>
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
              ...
              <td class="GroupDetail_band_portrait" width="425" valign="top">
                  ...
                  <tr>
                      <td class="GroupDetail_band_portrait" height="22" style="vertical-align:text-top; font:Courier; font-family:Courier; font-size:14px;"><b><?php if($params['direct_counsel_ind'] == 'Y') echo $params['direct_memo'];?></b></td>
                  </tr>
                      <tr>
                      ...
                      <tr>
                      <td class="GroupDetail_band_portrait" height="18" style="vertical-align:text-bottom; font:Arial; font-family:Arial;"><span class="GroupDetail_band_portrait" style="vertical-align:text-bottom; font:Arial; font-family:Arial;"><font size="2"><b><?php echo $params['branch_pan_no'];?></b></font></span></td>
                  </tr>
                  </table>

      <?php
      
      if ($bill_row['service_tax_amount'] > 0 && $bill_row['b_d'] >= '2012-07-01') { $service_dec = ''; }
      ?>
              
                  <p><span class="GroupDetail_band_portrait" style="vertical-align:text-bottom; font:Arial; font-family:Arial;"><font size="2"><b><?php echo $params['service_nature'];?></b></font></span></p>
                  <p><span class="GroupDetail_band_portrait" style="vertical-align:text-bottom;  font-size: text-align:justify; font:Arial; font-family:Arial; font-size:15px;"><b><?php echo $params['service_dec'];?></b></font></span></p> </td>
      ...
      ?>
          ...
          ?>
                  ...
                  <tr>
                      ...
                      <tr>
                      <td colspan="3" class="GroupDetail_band_portrait" height="20" align="center"><font size="+1"><b><?php if($params['recd_ind']=='on') {echo 'AMOUNT RECEIVED ';}?></b></font></td>
                  </tr>
                  </table>                </td>
              </tr>
          </table>
...
<script>
    ...
    function selectLookup(select) {
        ...
        {
            rangeFrom.disabled = false; rangeTo.disabled = false; inputCode.readOnly = true;
