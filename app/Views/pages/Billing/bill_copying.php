	...
	<div class="pagetitle col-md-12 float-start border-bottom pb-1">
		...
		<div class="myform">
				...
				<div class="frms-sec d-inline-block w-100 bg-white p-3 frmDv1">
					...
					<div class="frms-secLft col-md-12 float-start ">
						<div class="frms-sec-insde d-block float-start col-md-4 px-2 mb-2 position-relative">
							<label class="d-inline-block w-100 mb-2 lbl-mn">Serial# <strong class="text-danger">*</strong></label>
						...
						<div class="d-inline-block w-100">
						    ...
						    <button type="reset" class="btn btn-primary cstmBtn mt-3" id="resetBtn1" onclick="resetFields()">Reset</button>
						</div>
					</div>
				</div>
			</form>

			<form action="" method="post" id="billCopying2" name="billCopying2" class="d-none gffg" onsubmit="billCopy(event)">
				<div class="frmDv1">
					...
					<div class="col-md-12 float-start mt-0 pt-3">
						...
						<button type="submit" class="btn btn-primary cstmBtn mt-3" id="BilCpyprcdBtn2" onclick="formOption('/billing/copying/', 'proceed2', 'billCopying2')">Proceed</button>
						<a href="#" onclick="location.reload()" id="backbtn1" class="btn btn-primary cstmBtn btn-cncl mt-3 ms-2">Back</a>
					</div>
				</div>
			</form>
			...
			<div id="submitBtn" class="d-none">
				...
				<a href="#" onclick="location.reload()" class="btn btn-primary cstmBtn btn-cncl mt-3 ms-2">Back</a>
			</div>
