		...
		<div class="tbl-sec d-inline-block w-100 p-3 position-relative bg-white">
            ...
            <?php if($params['report_seqn'] == 'B'){
                ...
                ?>
                    ...
                    <?php
                        ...
                        $pageno = $pageno + 1 ;
                    ?>
                    <table class="table border-0 px-2" align="center" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        ...
                        <tr class="fs-14">
                            ...
                            <th width="" align="right" class="py-3 px-2">IP&nbsp;</th>
                            <th width="" align="right" class="py-3 px-2">OP&nbsp;</th>
                            <th width="" align="right" class="py-3 px-2">COUN&nbsp;</th>
                            <th width="" align="right" class="py-3 px-2">Billed&nbsp;</th>
                            <th width="" align="right" class="py-3 px-2">Realised&nbsp;</th>
                            <th width="" align="right" class="py-3 px-2">Balance&nbsp;</th>
                        </tr>      
                <?php
                            $lineno = 8 ;
                        }
                ...
                ?>                   
                                    <tr class="fs-14 border-0">
                                        <td height="" align="left" style="background-color: #e2e6506e;"  class="p-2">&nbsp;</td>
                                        <td height="" align="right" style="background-color: #e2e6506e;" class="p-2"><b>GRAND TOTAL</b>&nbsp;</td>
                                        <td height="" align="left" style="background-color: #e2e6506e;"  class="p-2">&nbsp;</td>
                                        <td height="" align="left" style="background-color: #e2e6506e;"  class="p-2">&nbsp;</td>
                                        <td height="" align="left" style="background-color: #e2e6506e;"  class="p-2">&nbsp;</td>
                                        <td height="" align="left" style="background-color: #e2e6506e;"  class="p-2">&nbsp;</td>
            ...
            <?php if($params['report_seqn'] == 'C'){ 
                ...
                ?>                   
                                ...
                                <tr class="fs-14 border-0">
                                    <td align="center"   class="p-2" colspan="4" style="background-color: #a0d3e5;"><b> Total</b>&nbsp;</td>
                                    <td align="right"  class="p-2" style="background-color: #a0d3e5;"><b><?php if($bbilamt > 0) { echo number_format($bbilamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td align="right"  class="p-2" style="background-color: #a0d3e5;"><b><?php if($bcolamt > 0) { echo number_format($bcolamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td align="right"  class="p-2" style="background-color: #a0d3e5;"><b><?php if($bbalamt > 0) { echo number_format($bbalamt,2,'.','') ;}?></b>&nbsp;</td>
                                </tr>
                <?php
                        $lineno = $lineno + 3;
                ...
                ?>
                                ...
                                <tr class="fs-14 border-0">
                                    ...
                                    <td align="right"  class="p-2" style="background-color: #e2e6506e;"><b><?php if($tbilamt > 0) { echo number_format($tbilamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td align="right"  class="p-2" style="background-color: #e2e6506e;"><b><?php if($tcolamt > 0) { echo number_format($tcolamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td align="right"  class="p-2" style="background-color: #e2e6506e;"><b><?php if($tbalamt > 0) { echo number_format($tbalamt,2,'.','') ;}?></b>&nbsp;</td>
                                </tr>
                        </table>
                        </td>
                    </tr>
            ...
            <?php if($params['report_seqn'] == 'M'){ 
                ...
                <table class="table border-0 px-2" align="center" border="0" cellspacing="0" cellpadding="0" style="background-color:#f6f9ff;">
                    ...
                    <tr class="fs-14">
                        <th height="" width="" align="left"  class="py-3 px-2">Bill No</th>
                        <th height="" width="" align="left"  class="py-3 px-2">Bill Dt</th>
                        <th height="" width="" align="left"  class="py-3 px-2">Client</th>
                        <th height="" width="" align="left"  class="py-3 px-2">Intl</th>
                        <th height="" width="" align="left" class="py-3 px-2">Billed&nbsp;</th>
                        <th height="" width="" align="left" class="py-3 px-2">Realised&nbsp;</th>
                        <th height="" width="" align="left" class="py-3 px-2">Balance&nbsp;</th>
                    </tr>
                <?php
                            $lineno = 8 ;
                            $pmatrind = 'Y' ;
                ...
                ?>
                                <tr class="fs-14">
                                    <td height="20" colspan="6" class="py-3 px-2"><b><?php echo $pmatrnm?></b></td>
                                </tr>
                <?php
                        $lineno = $lineno + 1;
                        $pmatrind = 'N' ;
                ...
                ?>
                                <tr class="fs-14">
                                    <td align="left"  class="py-3 px-2" style="vertical-align:top"><?php echo $report_row['bill_number']?></td> 
                                    <td align="left"  class="py-3 px-2" style="vertical-align:top"><?php echo date_conv($report_row['bill_date'])?></td> 
                                    <td align="left"  class="py-3 px-2" style="vertical-align:top"><?php echo strtoupper($report_row['client_name'])?></td>
                                    <td align="left"  class="py-3 px-2" style="vertical-align:top"><?php echo strtoupper($report_row['initial_code'])?></td>
                                    <td align="left" class="py-3 px-2"><?php if($report_row['billed_amount'] > 0) { echo number_format($report_row['billed_amount'],2,'.',''); } ?>&nbsp;</td>
                                    <td align="left" class="py-3 px-2"><?php if($report_row['realised_amount'] > 0) { echo number_format($report_row['realised_amount'],2,'.',''); }?>&nbsp;</td>
                                    <td align="left" class="py-3 px-2"><?php if($report_row['billed_amount']-$report_row['realised_amount'] > 0) { echo number_format(($report_row['billed_amount']-$report_row['realised_amount']),2,'.',''); }?>&nbsp;</td>
                                </tr>
                <?php     
                        $lineno = $lineno + 1;
                        $bbilamt = $bbilamt + $report_row['billed_amount'] ;
                ...
                ?>                   
                                ...
                                <tr class="fs-14">
                                    <td height="20" align="center"   class="py-3 px-2" style="background-color: #e2e6506e;" colspan="4"><b> Total</b>&nbsp;</td>
                                    <td height="20" align="left"  class="py-3 px-2" style="background-color: #e2e6506e;"><b><?php if($bbilamt > 0) { echo number_format($bbilamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td height="20" align="left"  class="py-3 px-2" style="background-color: #e2e6506e;"><b><?php if($bcolamt > 0) { echo number_format($bcolamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td height="20" align="left"  class="py-3 px-2" style="background-color: #e2e6506e;"><b><?php if($bbalamt > 0) { echo number_format($bbalamt,2,'.','') ;}?></b>&nbsp;</td>
                                </tr>
                <?php
                        $lineno = $lineno + 3;
                        $tbilamt = $tbilamt + $bbilamt ;
                ...
                ?>
                                ...
                                <tr class="fs-14">
                                    <td height="20" align="center" class="py-3 px-2" style="background-color: #94c0cf;" colspan="4" ><b>  GRAND TOTAL </b>&nbsp;</td>
                                    <td height="20" align="left"  class="py-3 px-2" style="background-color: #94c0cf;"><b><?php if($tbilamt > 0) { echo number_format($tbilamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td height="20" align="left"  class="py-3 px-2" style="background-color: #94c0cf;"><b><?php if($tcolamt > 0) { echo number_format($tcolamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td height="20" align="left"  class="py-3 px-2" style="background-color: #94c0cf;"><b><?php if($tbalamt > 0) { echo number_format($tbalamt,2,'.','') ;}?></b>&nbsp;</td>
                                </tr>
                        </table>
                        </td>
                    </tr>
            ...
            <?php if($params['report_seqn'] == 'I'){
                ...
                <table class="w-100" cellspacing="0" cellpadding="0">
                    <tr>
                        <td colspan="6">    
                            <table class="table border-0 px-2" cellspacing="0" cellpadding="0">
                                <tr>
                                <tr>
                                <td class="text-center border-0" colspan="4" align="center"><b>Sinha and Companyaaa</b></td>
                                </tr>
                                <tr>
                   ...
                   <tr class="fs-14">
                        <th height="" width="10%" align="left"  class="px-3 py-2">Bill No</th>
                        <th height="" width="08%" align="left"  class="px-3 py-2">Bill Dt</th>
                        <th height="" width="52%" align="left"  class="px-3 py-2">Client / Matter</th>
                        <th height="" width="10%" align="right" class="px-3 py-2">Billed&nbsp;</th>
                        <th height="" width="10%" align="right" class="px-3 py-2">Realised&nbsp;</th>
                        <th height="" width="10%" align="right" class="px-3 py-2">Balance&nbsp;</th>
                    </tr>
                ...
                ?>                   
                                ...
                                <tr class="fs-14 border-0">
                                    <td height="" align="right"  class="p-2" colspan="3" style="background-color: #e2e6506e;"><b> Total</b>&nbsp;</td>
                                    <td height="" align="right"  class="p-2" style="background-color: #e2e6506e;"><b><?php if($bbilamt > 0) { echo number_format($bbilamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td height="" align="right"  class="p-2" style="background-color: #e2e6506e;"><b><?php if($bcolamt > 0) { echo number_format($bcolamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td height="" align="right"  class="p-2" style="background-color: #e2e6506e;"><b><?php if($bbalamt > 0) { echo number_format($bbalamt,2,'.','') ;}?></b>&nbsp;</td>
                                </tr>
                <?php
                        $lineno = $lineno + 3;
                        $tbilamt = $tbilamt + $bbilamt ;
                ...
                ?>
                                ...
                                <tr class="fs-14">
                                    <td height="" align="center" class="py-2" colspan="3" style="background-color: #94c0cf;"><b> GRAND TOTAL </b>&nbsp;</td>
                                    <td height="" align="right"  class="py-2" style="background-color: #94c0cf;"><b><?php if($tbilamt > 0) { echo number_format($tbilamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td height="" align="right"  class="py-2" style="background-color: #94c0cf;"><b><?php if($tcolamt > 0) { echo number_format($tcolamt,2,'.','') ;}?></b>&nbsp;</td>
                                    <td height="" align="right"  class="py-2" style="background-color: #94c0cf;"><b><?php if($tbalamt > 0) { echo number_format($tbalamt,2,'.','') ;}?></b>&nbsp;</td>
                                </tr>
                        </table>
                        </td>
                    </tr>
