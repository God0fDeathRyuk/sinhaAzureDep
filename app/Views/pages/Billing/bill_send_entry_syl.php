...
<form action="" method="get" id="billSendEntry" name="billSendEntry" onsubmit="setValue(event)">
...
<form action="" method="post" id="" name="">
    <div class="d-inline-block w-100 mb-4 bnd">
				...
				<div class="d-inline-block w-100 mb-3">
					<button type="button" class="btn btn-primary cstmBtn mt-3 ms-2">Confirm</button>
					<a href="<?= $params['requested_url'] ?>" class="btn btn-primary cstmBtn btn-cncl mt-3 ms-2">Back</a>
				</div>
