...
<div class="pagetitle col-md-12 float-start border-bottom pb-1">
  <h1>Final Bill Open</h1>
</div>

<form action="" method="post" id="finalBillOpen" name="finalBillOpen">
<input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>">
	<div class="row">
		...
		<div class="inpt-grp col-md-8 pe-0 position-relative">
            ...
            <input type="text" class="form-control cstm-inpt w48 float-start me-2" name="bill_year" id="billYear" value='' required /> 
		...
		<div class="inpt-grp col-md-8 pe-0">
            ...
            <button type="submit" class="btn btn-primary cstmBtn mt-3" onclick="formOption('/billing/final-bill-open/', 'proceed', 'finalBillOpen')">Proceed</button>
			<button type="reset" class="btn btn-primary cstmBtn btn-cncl mt-3 ms-2">Reset</button>
</form>

<?php } else { ?>
<form action="" method="post" id="finalBillOpen2" name="finalBillOpen2">
	<div class="frms-sec d-inline-block w-100 bg-white p-3">
				...
				<div class="col-md-5 float-start px-2 mb-3">
					...
					<input class="form-control float-start w-54 ms-2" type="text"   name="bill_no" id="" value="<?= $params['bill_no'] ?>" readonly/>
					<input class="form-control float-start w-54 ms-2" type="hidden" name="ref_bill_serial_no" id="" value="<?= $record['ref_bill_serial_no'] ?>" readonly/>
				</div>
                <div class="col-md-4 float-start px-2 mb-3">
					<label class="d-inline-block w-100 mb-2 lbl-mn">Prepared By</label>
					<input type="text" class="form-control" name="prepared_by" value="<?= $record['prepared_by'] ?>" readonly />
				</div>
				...
				<div class="col-md-4 float-start px-2 mb-3">
					...
					<option value="1">Open for Bill Alteration</option>
					</select>
				</div>
