...
<div class="pagetitle">
		...
		<div class="col-md-12 mt-2">
			<div class="frms-sec d-inline-block w-100 bg-white p-3">
				...
				<div class="col-md-5 float-start px-1 mb-1 mt-2 position-relative">				
					<input type="text" class="form-control w-100 float-start" name="payee_payer_name" id="payee_payer_name" required readonly value="<?= ($options!='')?$data2[0]['payee_payer_name']:'' ?>"/>
	...
	<?php if ($options!=''){foreach ($data2 as $key => $value) {?>
		<form method="post" action="/sinhaco/query/voucher-view" name="qry_vou_frm<?= $key ?>" id="qry_vou_frm<?= $key ?>" >
