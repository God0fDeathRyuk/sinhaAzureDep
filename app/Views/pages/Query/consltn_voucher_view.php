		  ...
		  <div class="col-md-12 mt-2">
			<div class="frms-sec d-inline-block w-100 bg-white p-3">
				<div class="d-inline-block w-100 mt-2">
					<table class="table table-bordered tblePdngsml">
						...
						<tr>
							...
							<td>
								<span><?php if($option=='list'){ if ($data['daybook_code'] != '10') {echo $data['daybook_code'];} else {echo '';}}?></span>
							</td>
						</tr>
					</table>
					<table class="table table-bordered tblePdngsml">
				...
				<div class="frms-sec-insde d-block float-start col-md-12">
					<button type="button" class="btn btn-primary cstmBtn btn-cncl">Back</button>
				</div>
			</div>
