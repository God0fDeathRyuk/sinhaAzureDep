...
<?php if((!isset($case_qry))) { ?>
    <main id="main" class="main">
        ...
        <div class="pagetitle">
        <h1> Matter Details (PS & Other Side Details)</h1>
        </div><!-- End Page Title -->
                ...
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <div class="frms-sec d-inline-block w-100 bg-white p-3">				
                            ...
                            <div class="col-md-3 float-start px-2 mb-1">
                                <label class="d-inline-block w-100 mb-1 lbl-mn">Search On Matters <strong class="text-danger">*</strong></label>
                                <select class="form-select w-100 float-start" name="actv_on" required >
                            ...
                            <div class="col-md-3 float-start px-2 mb-1">
                                <label class="d-inline-block w-100 mb-1 lbl-mn">Report On <strong class="text-danger">*</strong></label>
                                <select class="form-select w-100 float-start" name="report_on" required >
                                    <option value="F">Filing Dt</option>
                                    <option value="A">Activity Dt</option>
                                </select>
                            </div>
        ...
        <?php
            ...
            ?>
                <table width="990" align="center" border="0" cellspacing="0" cellpadding="0" class="table border-0">
                    ...
                    <tr class="fs-14">
                        <th width="08%" align="left"  class="py-3 px-2">&nbsp;Mtr/Dt/Amt</th>
                        <th width="55%" align="left"  class="py-3 px-2">&nbsp;Matter Description/Judge/Court/Ref</th>
                        <th width="09%" align="left"  class="py-3 px-2">&nbsp;Last/Next</th>
                        <th width="30%" align="left"  class="py-3 px-2">&nbsp;Fixed For</th>
                    </tr>
            <?php
                        $lineno = 10 ;
                    }
            ?>
                <?php if($pcltind == 'Y') { ?>
                                <tr>
                                <td height="20" colspan="6" class="p-2" align="left"><b><?php echo strtoupper($pcltname) ?></b></td>
                            </tr>  
                <?php $lineno = $lineno + 1 ; $pcltind = 'N' ; } ?>
                                <tr class="fs-14">
                                    <td align="left"  class="p-2"><?php echo $report_row['matter_code']?></td> 
                                    <td align="left"  class="p-2"><?php echo $report_row['matter_desc']?></a></td>
                                    <td align="left"  class="p-2"><?php if ($report_row['activity_date'] != '' && $report_row['activity_date'] != '0000-00-00') { echo date_conv($report_row['activity_date']) ; } else { echo '&nbsp;' ; }?></td>
                                    <td align="left"  class="p-2" rowspan="2" style="vertical-align:top"><?php echo $report_row['prev_fixed_for'] ; ?></td>
                                </tr>
                                <tr class="fs-14">
                                ...
                                <tr class="fs-14">
                                    ...
                                    <td align="left"  class="p-2"><?php if ($report_row['next_date']     != '' && $report_row['next_date']     != '0000-00-00') { echo date_conv($report_row['next_date'])     ; } else { echo '&nbsp;' ; }?></td> 
                                    <td align="left"  class="p-2" rowspan="2" style="vertical-align:top"><?php echo $report_row['next_fixed_for'] ; ?></td>
                                </tr>
                                <tr class="fs-14">
                                    <td align="left"  class="p-2">&nbsp;</td> 
                                    <td align="left"  class="p-2" style="vertical-align:top"><?php echo $report_row['reference_desc']?></td> 
