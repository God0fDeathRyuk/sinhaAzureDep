...
<?php if((!isset($case_qry))) { ?>
    <main id="main" class="main">
        ...
        <form action="" method="post" id="matterHistory" name="matterHistory" onsubmit="setValue(event)">
                ...
                <div class="col-md-12 mt-2">
                    <div class="frms-sec d-inline-block w-100 bg-white p-3">				
                        ...
                        <div class="col-md-2 float-start px-2 mb-1 position-relative">
                            ...
                            <input type="text" class="form-control w-100 float-start pe-4" oninput="this.value = this.value.toUpperCase()" id="matterCode" onchange="fetchData(this, 'matter_code', ['matterDesc', 'clientCode', 'clientName'], ['matter_desc', 'client_code','client_name'], 'matter_code')" onfocusout="getMatterInfo(this)" name="matter_code" required>
                        ...
                        <div class="col-md-2 float-start px-2 mb-1">
                            ...
                            <input type="text" class="form-control w-100 float-start" id="clientCode" name="client_code" readonly>
                        </div>
                        <div class="col-md-5 float-start px-2 mb-1">
...
<?php } else { ?>
	...
	<main id="main" class="main <?= ($renderFlag) ? 'm0auto mtop90 ' : '' ?>" <?= (!$renderFlag) ? 'style="margin-top: 0px !important;"' : '' ?>>
        ...
        <?php
            ...
            ?>
                <tr class="fs-14">
                    <td align="right" class="p-2" style="text-align:center; font:Courier; word-break:break-all; font-family:Courier;" colspan="2"><i>Particulars</i></td> 
                    <td align="left"  class="p-2" style="word-break:break-all;" colspan="7"><?php echo $report_row['other_case_desc'];?>&nbsp;</td>
                </tr>
            <?php
                    $lineno = $lineno + 1 ; 
            ...
            ?>
                <tr class="fs-14">
                    <td align="right" class="p-2"style="word-break:break-all;" colspan="2">&nbsp;</td> 
                    <td class="p-2" style="text-align:left; font:Arial; font-family:Arial;word-break:break-all;" colspan="7"><i><?php echo $header_desc;?></i></td>
                </tr>
            <?php
                    $lineno = $lineno + 1 ;
                    if($lineno >= $maxline)
            ...
            ?>
                <table width="950" align="center" border="0" cellspacing="0" cellpadding="0" class="table border-0">
                    ...
                    <tr class="fs-14">
                        ...
                        <th height="18" width="08%" align="left"  class="py-3 px-2">&nbsp;Rec Sl#</th>
                        <th height="18" width="08%" align="left"  class="py-3 px-2">&nbsp;Date</th>
                        <th height="18" width="40%" align="left"  class="py-3 px-2">&nbsp;Reference No/Court/Judge</th>
                        <th height="18" width="10%" align="left"  class="py-3 px-2">&nbsp;Filing Dt/Amt</th>
                        <th height="18" width="08%" align="left"  class="py-3 px-2">&nbsp;Prev Date/</th>
                        <th height="18" width="08%" align="left"  class="py-3 px-2">&nbsp;Next Date</th>
                        <th height="18" width="23%" align="left"  class="py-3 px-2">&nbsp;Fix For</th>
                        <th height="18" width="23%" align="left"  class="py-3 px-2">&nbsp;Remarks</th>
                    </tr>
            <?php
                        $lineno = 10 ;
                    }
