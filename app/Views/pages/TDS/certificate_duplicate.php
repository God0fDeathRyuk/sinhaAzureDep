...
<?php endif; ?>
		...
		<h1>TDS Certificate-Payable (Duplicate)</h1>
		</div>

		<form action="" method="post">
			<div class="frms-sec d-inline-block w-100 bg-white p-3">
                    <div class="frms-sec-insde d-block float-start col-md-4 pe-2 mb-4">
                        <label class="d-inline-block w-100 mb-2 lbl-mn">Certificate No</label>
                        <input type="text" class="form-control float-start set-date" name="tds_cert_no" />
					...
					<div class="frms-sec-insde d-block float-start col-md-4 px-2 mb-4">
						...
						<select class="form-select cstm-inpt" name="branch_code" id="branchCode">
        		...
        		<!-- <option value="<?php // echo $finyr_row[fin_year]?>" <?php // if($global_curr_finyear == $finyr_row[fin_year]) { echo 'selected' ; }?>><?php // echo $finyr_row[fin_year]?></option> -->
					...
					<div class="col-md-2 float-start px-2 mb-3">
						<label class="d-inline-block w-100 mb-2 lbl-mn">Quarter No</label>
						<select class="form-select" name="quarter_no" id="quarterNo" onchange="myqtrno(this)">
					...
					<div class="col-md-4 float-start px-2 mb-3">
						...
						<select class="form-select" name="payee_payer_type" id="certStatus" onchange="cleanData('payeeCode')" required>
