...
<?php endif; ?>
		...
		<h1>TDS Certificate Status (Payable)</h1>
		</div>
			...
			<div class="frms-sec d-inline-block w-100 bg-white p-3">
               ...
               <div class="col-md-4 float-start px-2 mb-3">
                  ...
                  <input type="text" class="form-control" name="payee_name" id="payeeName" readonly/>
					...
					<div class="col-md-4 float-start px-2 mb-3">
						<label class="d-inline-block w-100 mb-2 lbl-mn">Certificate Status <strong class="text-danger">*</strong></label>
						<select class="form-select" name="cert_status" required>
                        <option value="">--Select--</option>
...
<main id="main" class="main <?= ($renderFlag) ? 'm0auto mtop90 ' : '' ?>" <?= (!$renderFlag) ? 'style="margin-top: 0px !important;"' : '' ?>>
         <div class="position-absolute btndv">
            ...
            //foreach ($tdscert_qry as $report_row)
            {
            // echo '<pre>';print_r($report_row);continue;
               $mgramt = 0; 
               $mtxamt = 0; 
         ...
         ?>
                  <table class="table border-0" cellspacing="0" cellpadding="0">
                        <tr>
                           ...
                           <table class="table border-0" align="center" border="0" width="100%">
                              <tr>
                              ...
                              <tr>
                                 <td colspan="9" class="text-center border-0">&nbsp;</td>
                              </tr>
                              <tr>
                                 <td colspan="7" class="border-0 w-65">
                                       <p class="d-block w-100 text-uppercase">
                                          <span class="w-15 d-block float-start">Branch  </span><strong>: <?= $params['branch_name'] ?> </strong>
                                       </p>
                                          <p class="d-block w-100 text-uppercase">
                                                <span class="w-15 d-block float-start">Date  </span><strong>: <?= $params['date'] ?> </strong>
                                             </p>
                                             <p class="d-block w-100 text-uppercase">
                                                <span class="w-15 d-block float-start">Year </span><strong>: <?= $params["fin_year"]?> </strong>
                                             </p>
                                    </td>
                                    <td  colspan="2" class="border-0">
                                             <p class="d-block w-100 text-uppercase">
                                                <span class="w-15 d-block float-start">Page </span><strong>: <?= $pageno?> </strong>
                                             </p>
                                                <p class="d-block w-100 text-uppercase">
                                                   <span class="w-15 d-block float-start">As On </span><strong>: <?= $params["ason_date"]  ?> </strong>
                                                </p>
                                                <p class="d-block w-100 text-uppercase">
                                                   <span class="w-15 d-block float-start">Payee </span><strong>: 
                                       <?php if($params["payee_code"] != '%') { echo strtoupper($params["payee_name"]) ; }  else { echo 'ALL' ; } ?> </strong>
                        ...
                        <tr class="fs-14">
                           ...
                           <th class="border px-3 py-2">Typ</th>
         ...
         ?>
                                 <tr class="fs-14">
                                    <td height="20" align="left"  class="px-2 py-2 align-text-top" style="vertical-align:top">&nbsp;<?php echo date_conv($report_row['doc_date'],'-')?></td> 
                                    <td height="20" align="left"  class="px-2 py-2 align-text-top" style="vertical-align:top">&nbsp;<?php echo $report_row['daybook_code']?></td>
                                    <td height="20" align="left"  class="px-2 py-2 align-text-top" style="vertical-align:top">&nbsp;<?php echo $report_row['doc_type']?></a></td>
                                    <td height="20" align="left"  class="px-2 py-2 align-text-top" style="vertical-align:top">&nbsp;<?php echo $report_row['doc_no']?></td>
                                    <td height="20" align="left"  class="px-2 py-2 align-text-top" style="vertical-align:top">&nbsp;<?php echo $report_row['payee_payer_name']?></td>
                                    <td height="20" align="right" class="px-2 py-2 align-text-top" style="vertical-align:top"><?php echo $report_row['gross_amount'] ?>&nbsp;</td>
                                    <td height="20" align="right" class="px-2 py-2 align-text-top" style="vertical-align:top"><?php echo $report_row['tax_amount'] ?>&nbsp;</td>
                                    <td height="20" align="left"  class="px-2 py-2 align-text-top" style="vertical-align:top">&nbsp;<?php echo $report_row['tds_cert_no']?></td>
                                    <td height="20" align="left"  class="report_detail_none px-2 py-2 align-text-top"  style="vertical-align:top">&nbsp;<?php if($report_row['tds_cert_date'] != '' && $report_row['tds_cert_date'] != '0000-00-00') { echo date_conv($report_row['tds_cert_date'],'-') ; }?></td> 
                                 </tr>
         <?php     
                  $lineno = $lineno + 1;
         ...
         ?>                   
                                 <tr  class="fs-14 border-0">
                                    ...
                                    <td height="20" align="right" class="p-2" style="background-color: #e2e6506e; vertical-align:middle;"><b><?php echo number_format($mgramt,2,'.','') ?></b>&nbsp;</td>
         ...
         ?>
                                 ...
                                 <tr class="fs-14 border-0">
                                    <td height="20" align="center" style="background-color: #a1d1e4;" class="p-2" colspan="5"><b>GRAND TOTAL</b>&nbsp;</td>
                                    ...
                                    <td height="20" align="left" style="background-color: #a1d1e4;" class="p-2">&nbsp;</td>
                                    <td height="20" align="right" style="background-color: #a1d1e4;" class="p-2">&nbsp;</td>
                                 </tr>
                           </table>
                        </td>
                     </tr>
