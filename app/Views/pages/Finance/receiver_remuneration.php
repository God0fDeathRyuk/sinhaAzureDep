...
<?php if((!isset($bill_qry))) { ?>
    <main id="main" class="main">
        ...
        <div class="pagetitle">
        <h1>Receiver Remuneration(Court/Client/Matter)</h1>
        </div><!-- End Page Title -->

        <form action="" method="post" id="receiverRemuneration" name="receiverRemuneration" onsubmit="setValue(event)">
            ...
            <div class="row">
                <div class="col-md-12 mt-2">
                    <div class="frms-sec d-inline-block w-100 bg-white p-3">
                        ...
                        <div class="col-md-4 float-start px-2 mb-1">
                            <label class="d-inline-block w-100 mb-1 lbl-mn">AT-A-GLANCE</label>
                            <input type="checkbox" name="AT-A-GLANCE">
                        </div>
                        <div class="col-md-4 float-start px-2 mb-1">
...
<?php } else if(!$at_a_glance) { ?>
	...
	<main id="main" class="main <?= ($renderFlag) ? 'm0auto mtop90 ' : '' ?>" <?= (!$renderFlag) ? 'style="margin-top: 0px !important;"' : '' ?>>
            ...
            <?php
                    ...
                    $pageno = $pageno + 1 ;
            ?>
                    <table width="950" align="center" border="0" cellspacing="0" cellpadding="0" class="border-0 table">
                        <tr>
                            <td colspan="6">    
                        ...
                        <tr class="fs-14">
                            <th height="18" width="6%" align="left"  class="py-3 px-2">Doc No</th>
                            <th height="18" width="8%" align="left"  class="py-3 px-2">Doc Dt</th>
                            <th height="18" width="45%" align="left"  class="py-3 px-2">Client / Matter / Narration</th>
                            <th height="18" width="17%" align="right" class="py-3 px-2">Gross Amount (Rs.)&nbsp;</th>
                            <th height="18" width="10%" align="right" class="py-3 px-2">TDS (Rs.)&nbsp;</th>
                            <th height="18" width="14%" align="right" class="py-3 px-2">Net Amount (Rs.)&nbsp;</th>
                        </tr>
            ...
            ?>
                                    <tr class="fs-14">
                                        <td height="20" align="left"   class="p-2" colspan="3"><b>** Total</b>&nbsp;</td>
                                        <td height="20" align="right"  class="p-2"><b><?php if($lgtotamt > 0) { echo number_format($lgtotamt,2,'.','') ;}?></b>&nbsp;</td>
                                        <td height="20" align="right"  class="p-2"><b><?php if($lttotamt > 0) { echo number_format($lttotamt,2,'.','') ;}?></b>&nbsp;</td>
                                        <td height="20" align="right"  class="p-2"><b><?php if($ltotamt > 0) { echo number_format($ltotamt,2,'.','') ;}?></b>&nbsp;</td>
                                    </tr>
                                    <tr class="fs-14">
                                        <td height="15" colspan="11"><hr size="1" color="#CCCCCC" noshade></td>
                                    </tr>
            <?php
                    $lineno  = $lineno + 2;
            ...
            ?>                   
                                    ...
                                    <tr class="fs-14">
                                        ...
                                        <td height="20" align="right"  class="p-2" style="background-color: #91d6ec6e;"><b><?php if($gttotamt > 0) { echo number_format($gttotamt,2,'.','') ;}?></b>&nbsp;</td>
                                        <td height="20" align="right"  class="p-2" style="background-color: #91d6ec6e;"><b><?php if($tttotamt > 0) { echo number_format($tttotamt,2,'.','') ;}?></b>&nbsp;</td>
                                        <td height="20" align="right"  class="p-2" style="background-color: #91d6ec6e;"><b><?php if($ttotamt > 0) { echo number_format($ttotamt,2,'.','') ;}?></b>&nbsp;</td>
                                    </tr>
                                    <tr class="fs-14">
                                        <td height="15" colspan="11"><hr size="2" noshade></td>
                                    </tr>
                            </table>
                            </td>
                        </tr>
...
<?php } else { ?>
	...
	<main id="main" class="main <?= ($renderFlag) ? 'm0auto mtop90 ' : '' ?>" <?= (!$renderFlag) ? 'style="margin-top: 0px !important;"' : '' ?>>
            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0">
                <tr class="ReportColumn_portrait">
                <td width="098" align="left">Code</td>
                <td width="1">&nbsp;</td>
                <td width="500" align="left">Name</td>
                <td width="1">&nbsp;</td>
                <td width="100" align="right">Gross Amount</td>
                <td width="100" align="right">TDS</td>
                <td width="100" align="right">Net Amount</td>
                </tr>
                <tr>
                ...
                <?php
                    ...
                    <tr class="GroupDetail_band_portrait">
                    <td align="left" style="vertical-align:top;"><?= isset($report_row['c_code']) ? $report_row['c_code'] : '';?></td>
                    <td>&nbsp;</td>
                    <td align="left" style="vertical-align:top;"><?php echo $report_row['c_name'];?></td>
                    <td>&nbsp;</td>
                    <td align="right" style="vertical-align:top;"><?php echo number_format($report_row['gross_amount'],2,'.','');?></td>
                    <td align="right" style="vertical-align:top;"><?php if($report_row['tax_amount'] > 0) {echo number_format($report_row['tax_amount'],2,'.','');}?></td>
                    <td align="right" style="vertical-align:top;"><?php echo number_format($report_row['net_amount'],2,'.','');?></td>
                    </tr>
                    <?php     
                        $report_row = ($rowcnt < $report_cnt) ? $bill_qry[$rowcnt] : $report_row;  
                        $rowcnt = $rowcnt + 1 ;
...
<script>
    function setValue(e) {
        e.preventDefault();
        var asondt     = document.receiverRemuneration.ason_date.value ; 
        var asdtymd    = asondt.substr(6,4)+asondt.substr(3,2)+asondt.substr(0,2) ;

        if (document.receiverRemuneration.start_date.value.substring(6,10)+document.receiverRemuneration.start_date.value.substring(3,5)+document.receiverRemuneration.start_date.value.substring(0,2) > asdtymd) {
            Swal.fire({ text: 'Start Date must be less than equal to As On Date !!!' }).then((result) => { setTimeout(() => {document.receiverRemuneration.start_date.focus()}, 500) });
            return false;
        }
        else if (document.receiverRemuneration.end_date.value.substring(6,10)+document.receiverRemuneration.end_date.value.substring(3,5)+document.receiverRemuneration.end_date.value.substring(0,2) > asdtymd) {
            Swal.fire({ text: 'End Date must be less than or equal to As On Date !!!' }).then((result) => { setTimeout(() => {document.receiverRemuneration.end_date.focus()}, 500) });
            return false;
        }
        else if (document.receiverRemuneration.start_date.value.substring(6,10)+document.receiverRemuneration.start_date.value.substring(3,5)+document.receiverRemuneration.start_date.value.substring(0,2) > document.receiverRemuneration.end_date.value.substring(6,10)+document.receiverRemuneration.end_date.value.substring(3,5)+document.receiverRemuneration.end_date.value.substring(0,2)) {
            Swal.fire({ text: 'End Date must be less than or equal to Start Date' }).then((result) => { setTimeout(() => {document.receiverRemuneration.end_date.focus()}, 500) });
            return false;
        }  
        
        document.receiverRemuneration.submit();
    }
</script>
<?= $this->endSection() ?>