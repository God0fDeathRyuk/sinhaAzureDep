...
<?php endif; ?>
<div class="pagetitle">
      <h1>Courier Rate Master [<?php echo strtoupper($option) ?>] </h1>
    </div><!-- End Page Title -->
    <form action="<?php if($option == 'Add'){ echo "/sinhaco/master/mas-courier?user_option=Add";} if($option == 'Edit'){ echo '/sinhaco/master/mas-courier?user_option=Edit';}if($option == 'Delete'){ echo '/sinhaco/master/mas-courier?user_option=Delete';}?>" method="post" >
			...
			<div class="frms-sec d-inline-block w-100 bg-white p-3">
				...
				<div class="d-inline-block w-100 btmDv">
					...
					<div class="col-md-8 float-start mb-3 px-2 position-relative">
						<label class="d-inline-block w-100 mb-2 lbl-mn">Agency Name <strong class="text-danger">*</strong></label>
					...
					<div class="col-md-4 float-start mb-3 px-2">
						<label class="d-inline-block w-100 mb-2 lbl-mn">Particulars <strong class="text-danger">*</strong></label>
						<input type="text" class="form-control w-100 float-start me-2" placeholder="Particulars" name="rate_desc" id="rate_desc" value="<?= ($option!='Add')?$data['rate_desc']:'' ?>" required <?php echo $redokadd;?>/>
					</div>					
					<div class="col-md-4 float-start mb-3 px-2">
					...
					<div class="col-md-4 float-start mb-3 px-2">
						...
						<button type="submit" class="btn btn-primary cstmBtn mt-2" onclick="return courier_master_check()" <?php echo $disview;?>>Save</button>
